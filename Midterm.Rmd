...
Math_AV_Plot <- ggplot(Math_AV) +
  ...
  annotate(geom="text", x=2020.7, y=38,
           label="(Decreased by approximetly 3.2%)", color="red", size=3.5) +
  annotate(geom="text", x=2020.8, y=41,
           label="(Decreased by approximetly 3.9%)", color="#008080", size=3.5) +
...
RLA_AV_PLOT <- ggplot(RLA_AV) +
  ...
  annotate(geom="text", x=2021, y=61,
           label="(Decreased by approximetly 3.8%)", color="#008080", size=3.5) +
  annotate(geom="text", x=2021, y=50,
           label="(Decreased by approximetly 3.1%)", color="red", size=3.5) +
...
RLA_bar_21<- ggplot(RLA_tri_data_21) +
  ...
  annotate(geom="text", x="NEW JERSEY", y=58,
           label="(Decreased by approximetly 4%)", color="#8B8000", size=3.5) +
  annotate(geom="text", x="NEW YORK", y=86,
           label="(Decreased by approximetly 10%)", color="forestgreen", size=3.5) +
...
math_bar_21<- ggplot(Math_tri_data_21) +
  ...
  annotate(geom="text", x="NEW JERSEY", y=37,
           label="(Decreased by approximetly 6%)", color="#8B8000", size=3.5) +
annotate(geom="text", x="NEW YORK", y=94,
         label="(Decreased by approximetly 3%)", color="forestgreen", size=3.5) +
...
p.dash <- (RLA_AV_PLOT + Math_AV_Plot)/(RLA_bar_19+ math_bar_19 + RLA_bar_21 + math_bar_21) +
  ...
  plot_annotation(
    ...
    caption = 'Source: U.S Department of Education EDFacts Data'
  )
